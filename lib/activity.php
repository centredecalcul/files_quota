...
class Activity implements IExtension {
    ...
    const APP_NAME = 'files_quota';

    /**
     * Filter with all app related activities
     */
    const FILTER_AVIR = 'files_quota';

    /**
     * Activity types known to this extension
     */
    const TYPE_TOO_MUCH_FILES = 'nb_files';

    /**
     * Subject keys for translation of the subjections
     */
    const SUBJECT_TOO_MUCH_FILES = 'nb_files';
    ...
    public function getNotificationTypes($languageCode) {
        ...
        return [
            self::TYPE_TOO_MUCH_FILES => (string) $l->t('<strong>Not enough storages</strong> too much <strong>files</strong>'),
        ];
    }
    ...
    public function translate($app, $text, $params, $stripPath, $highlightParams, $languageCode) {
        ...
        if ($app === self::APP_NAME) {
            switch ($text) {
                case self::SUBJECT_TOO_MUCH_FILES:
                    return (string) $l->t('Too much files', $params);
    ...
    public function filterNotificationTypes($types, $filter) {
        return $filter === self::FILTER_AVIR ? [self::TYPE_TOO_MUCH_FILES] : $types;
    }
